...
#define POSE_TOPIC1 "/state_estimation" // Update the topic name
...
{
public:
  PoseImageSyncNode() : Node("pose_image_sync_node"), gravity_pose_saved_(false), init_gravity_pose_path_(SAVE_GRAVITY_POSE_PATH)
  {
    // 创建 QoS 设置
    ...
    typedef message_filters::sync_policies::ApproximateTime<
        nav_msgs::msg::Odometry, // Updated type
...
private:
  ...
  void callback(const nav_msgs::msg::Odometry::ConstSharedPtr &pose1, // Update the parameter type
                const sensor_msgs::msg::Image::ConstSharedPtr &image1,
                const sensor_msgs::msg::Image::ConstSharedPtr &image2)
  {
    static int index = 0;
    RCLCPP_INFO(this->get_logger(), "Received synchronized odometry and images");
  ...
  void save_pose_quaternion(const nav_msgs::msg::Odometry::ConstSharedPtr &pose) // Update the parameter type
  {
    // 创建pose_quat.txt文件
    ...
    file << pose->pose.pose.orientation.w << " "
  ...
  message_filters::Subscriber<nav_msgs::msg::Odometry> pose_sub1_; // Update the subscriber type
  ...
  std::shared_ptr<message_filters::Synchronizer<message_filters::sync_policies::ApproximateTime<
      nav_msgs::msg::Odometry, sensor_msgs::msg::Image, sensor_msgs::msg::Image>>>
      sync_;
  ...
  std::string init_gravity_pose_path_;
};
